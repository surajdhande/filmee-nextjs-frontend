      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 pt-20 z-10">
        <div className="max-w-xl">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight text-white mb-6">
            Investment Tools <span className="text-red-500">Page</span>
          </h1>
          <p className="text-zinc-400 text-sm sm:text-base md:text-lg mb-10 max-w-md mx-auto leading-relaxed">
            This page is under development. Please check back soon for updates.
          </p>
          <Link href="/">
            <button className="bg-gradient-to-r from-red-700 via-red-650 to-red-550 hover:from-red-650 hover:to-red-450 text-white px-10 py-4 rounded-full text-xs sm:text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:scale-105 shadow-[0_0_25px_rgba(220,38,38,0.35)] hover:shadow-[0_0_35px_rgba(220,38,38,0.55)]">
              Back to Home
            </button>
          </Link>
        </div>
