...
export default function MessagesPage({ onBack }) {
  return (
    <main className="flex flex-col min-h-screen bg-[#0a0a0a] text-white font-sans">
      {/* ── Header ─────────────────────────────────────────────────────────── */}
      <header className="h-20 border-b border-zinc-900 bg-[#0a0a0a] flex items-center px-8 gap-6 flex-shrink-0">
        <button
          onClick={onBack}
      ...
      <div className="flex-1 flex min-h-0 relative">
        ...
        <div className="w-[380px] border-r border-zinc-900 flex items-center justify-center p-8 flex-shrink-0">
          <div className="bg-[#141414] border border-zinc-800/70 rounded-2xl p-8 flex flex-col items-center text-center justify-center min-h-[260px] w-full">
            ...
            <h3 className="text-lg font-black text-white">No Active Chats</h3>
        ...
        <div className="flex-1 flex items-center justify-center p-12">
          <div className="bg-[#141414] border border-zinc-800/70 rounded-2xl p-8 max-w-md w-full flex flex-col items-center text-center justify-center min-h-[300px]">
