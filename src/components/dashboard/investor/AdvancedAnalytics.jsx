  ...
  return (
    <div className="min-h-screen bg-[#0B0B0B] text-white flex flex-col">
      ...
      <header className="w-full border-b border-[#262626] bg-[#0E0E0E] shrink-0">
        <div className="flex items-center justify-between px-4 py-3 gap-2 flex-wrap lg:px-6 lg:py-4">
          <div className="flex items-center gap-2 lg:gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-[15px] font-bold text-white tracking-tight lg:text-[18px]">Advanced Analytics</h1>
                <LiveBadge offline={!liveMode} />
              </div>
              <p className="text-[11px] text-zinc-500 mt-0.5 lg:text-xs">Real-time insights and performance metrics</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap lg:gap-3">
            <button
              ...
              className={`flex items-center gap-1.5 rounded-full px-3 py-1.5 text-[11px] font-bold uppercase tracking-wider transition-all duration-300 lg:px-5 lg:py-2 lg:gap-2 lg:text-[12px] ${
                liveMode
            ...
            <button className="hidden sm:flex items-center gap-1.5 border border-[#333] text-zinc-400 hover:text-white rounded-full px-4 py-2 text-xs transition">
      ...
      {/* ── PAGE BODY ──────────────────────────────────────────────────────── */}
      <div className="flex-1 overflow-y-auto p-4 space-y-6 lg:p-8 lg:space-y-8">
